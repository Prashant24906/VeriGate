...
const shieldRings = [
  { size: 230, duration: 8,  color: "rgba(31,92,74,0.25)",    dir: 1  },
  { size: 300, duration: 14, color: "rgba(242,167,59,0.2)",   dir: -1 },
  { size: 380, duration: 20, color: "rgba(31,92,74,0.1)",     dir: 1  },
];
...
function FeatureCard({ f, delay }: { f: typeof features[0]; delay: number }) {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      style={{
        background: hovered ? "#EFE6CF" : "#FFFFFF",
        border: `1px solid ${hovered ? `${f.color}66` : "rgba(23,31,51,0.1)"}`,
        borderRadius: 20,
        padding: "1.75rem",
        transition: "border-color 0.3s, background 0.3s, transform 0.3s, box-shadow 0.3s",
        transform: hovered ? "translateY(-6px)" : "translateY(0)",
        boxShadow: hovered ? "0 20px 50px -15px rgba(23,31,51,0.18)" : "none",
        position: "relative",
        overflow: "hidden",
        cursor: "default",
      }}
    >
      ...
      <h3 style={{ fontSize: "1rem", fontWeight: 700, color: "#171F33", marginBottom: "0.5rem" }}>
        {f.title}
      </h3>
      <p style={{ fontSize: "0.875rem", color: "#3D4A6B", lineHeight: 1.65 }}>
        {f.desc}
      </p>
    </motion.div>
  );
  ...
  return (
    <div style={{ flex: 1 }}>
      ...
      <section style={{
        ...
        alignItems: "stretch",
        width: "100%",
        background: "linear-gradient(135deg, #F6F0E1 0%, #EDE2C8 50%, #E4D5B0 100%)",
      }}>
        {/* Grid pattern */}
        <div style={{
          position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0,
          backgroundImage:
            "linear-gradient(rgba(31,92,74,0.04) 1px, transparent 1px)," +
            "linear-gradient(90deg, rgba(31,92,74,0.04) 1px, transparent 1px)",
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(242,167,59,0.18) 0%, transparent 70%)",
          top: -200, left: -150,
        }} />
        <div style={{
          position: "absolute", borderRadius: "50%", filter: "blur(80px)",
          pointerEvents: "none", width: 600, height: 600,
          background: "radial-gradient(circle, rgba(31,92,74,0.14) 0%, transparent 70%)",
          bottom: -150, right: 50,
        }} />
        ...
        <div style={{
          ...
          padding: "3rem clamp(1.25rem,4vw,2.5rem)", width: "100%", flex: 1,
          ...
          >
            ...
            <motion.div
              style={{
                ...
                color: "#D98A1F", fontSize: "0.8rem", fontWeight: 700,
            ...
            <h1 style={{
              ...
              <span style={{ color: "#171F33" }}>AI-Powered</span>
              <span style={{
                background: "linear-gradient(90deg, #1F5C4A, #3FA582, #F2A73B)",
              ...
              <span style={{ color: "#171F33" }}>at the Border</span>
            </h1>

            {/* Subtitle */}
            <p style={{
              color: "#3D4A6B", fontSize: "1.05rem", lineHeight: 1.8,
            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              <Link href="/screen">
                <motion.div
                  style={{
                    ...
                    background: "#171F33",
                    color: "#F2A73B", fontWeight: 700, fontSize: "0.95rem",
                    padding: "13px 26px", borderRadius: 100, cursor: "pointer",
                    boxShadow: "0 10px 30px -8px rgba(23,31,51,0.4)",
                  }}
                  whileHover={{ y: -3, boxShadow: "0 16px 36px -8px rgba(23,31,51,0.5)" }}
                  whileTap={{ scale: 0.97 }}
                >
                  <ScanLine size={20} />
                  Start Screening
              ...
              <Link href="/dashboard">
                <motion.div
                  style={{
                    display: "inline-flex", alignItems: "center", gap: 8,
                    background: "transparent", color: "#171F33", fontWeight: 600,
                    fontSize: "0.95rem", padding: "13px 26px", borderRadius: 100,
                    cursor: "pointer", border: "1.5px solid #171F33",
                  }}
                  whileHover={{ backgroundColor: "#171F33", color: "#F6F0E1" }}
                  whileTap={{ scale: 0.97 }}
                >
                  View Dashboard
                </motion.div>
          ...
          >
            ...
            <div style={{
              ...
              background: "linear-gradient(135deg, rgba(31,92,74,0.12), rgba(242,167,59,0.1))",
              border: "1.5px solid rgba(31,92,74,0.4)", borderRadius: 32,
              display: "flex", alignItems: "center", justifyContent: "center",
              color: "#1F5C4A",
              boxShadow: "0 0 60px rgba(31,92,74,0.15), inset 0 0 30px rgba(31,92,74,0.05)",
              zIndex: 1,
            }}>
            ...
            {[0, 60, 120, 180, 240, 300].map((deg, i) => (
              <motion.div
                ...
                style={{
                  ...
                  background: "#F2A73B", boxShadow: "0 0 10px rgba(242,167,59,0.8)",
      ...
      <section style={{
        ...
        borderTop: "1px solid rgba(23,31,51,0.1)",
        borderBottom: "1px solid rgba(23,31,51,0.1)",
        background: "#FFFFFF",
      }}>
        {statsData.map((s, i) => (
          <motion.div
            key={s.label}
            style={{
              flex: "1 1 25%", minWidth: 120, display: "flex", flexDirection: "column",
              alignItems: "center", padding: "1.75rem 1rem", gap: 4,
              borderRight: i < statsData.length - 1 ? "1px solid rgba(23,31,51,0.08)" : "none",
            }}
          ...
          >
            <span style={{
              ...
              background: "linear-gradient(90deg, #1F5C4A, #F2A73B)",
              WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text",
            }}>{s.value}</span>
            <span style={{
              fontSize: "0.78rem", color: "rgba(61,74,107,0.65)",
      ...
      {/* ── AI MODULE SUITE ──────────────────────────────────────── */}
      <section style={{ padding: "5rem clamp(1.25rem,4vw,2.5rem)", maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 800, color: "#171F33", marginBottom: "0.75rem" }}>
            AI Module Suite
          </h2>
          <p style={{ color: "#3D4A6B", fontSize: "1rem", maxWidth: 500, margin: "0 auto" }}>
      ...
      {/* ── HOW IT WORKS ─────────────────────────────────────────── */}
      <section style={{ padding: "5rem clamp(1.25rem,4vw,2.5rem)", background: "#EFE6CF", width: "100%" }}>
        <motion.div
          style={{ textAlign: "center", marginBottom: "3rem", maxWidth: 1200, margin: "0 auto 3rem" }}
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
        >
          ...
          <p style={{ color: "#3D4A6B", fontSize: "1rem" }}>
        ...
        <div style={{
          ...
          {steps.map((step, i) => (
            <motion.div
              key={step.n}
              style={{
                flex: "1 1 220px", minWidth: 220, maxWidth: 300,
                background: "#FFFFFF", border: "1px solid rgba(23,31,51,0.1)",
              ...
              viewport={{ once: true }}
              whileHover={{ y: -6, boxShadow: "0 20px 50px -15px rgba(23,31,51,0.15)" }}
            >
              <span style={{
                fontFamily: "monospace", fontSize: "0.75rem", fontWeight: 700,
                color: "#1F5C4A", letterSpacing: "0.1em",
                background: "rgba(31,92,74,0.1)", border: "1px solid rgba(31,92,74,0.2)",
              ...
              <div style={{
                ...
                background: "rgba(31,92,74,0.08)", border: "1px solid rgba(31,92,74,0.2)",
                display: "flex", alignItems: "center", justifyContent: "center", color: "#1F5C4A",
              }}>
                <step.icon size={26} />
              </div>
              <h3 style={{ fontSize: "1.05rem", fontWeight: 700, color: "#171F33", marginBottom: "0.5rem" }}>
                {step.title}
              </h3>
              <p style={{ fontSize: "0.85rem", color: "#3D4A6B" }}>{step.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
        ...
        <div style={{
          ...
          {verdicts.map((v, i) => (
            <motion.div
              key={v.level}
              style={{
                background: "#FFFFFF", border: `1px solid ${v.color}55`,
                borderRadius: 20, padding: "1.75rem 1.25rem", textAlign: "center",
                display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem",
                boxShadow: "0 2px 12px rgba(23,31,51,0.05)",
              }}
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ delay: i * 0.1 }}
              viewport={{ once: true }}
              whileHover={{ y: -6, boxShadow: "0 16px 40px -12px rgba(23,31,51,0.14)" }}
            >
              ...
              <p style={{ fontSize: "0.8rem", color: "#3D4A6B", marginTop: "0.25rem" }}>{v.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* ── CTA BANNER ───────────────────────────────────────────── */}
      <section style={{
        background: "linear-gradient(135deg, #123B30, #1F5C4A)",
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 800, color: "#F6F0E1", marginBottom: "0.75rem" }}>
            Ready to Screen a Document?
          </h2>
          <p style={{ color: "rgba(246,240,225,0.75)", marginBottom: "2rem", fontSize: "1rem" }}>
          ...
          <Link href="/screen">
            <motion.div
              style={{
                ...
                background: "#F2A73B",
                color: "#171F33", fontWeight: 700, fontSize: "0.95rem",
                padding: "14px 30px", borderRadius: 100, cursor: "pointer",
                boxShadow: "0 10px 30px -8px rgba(242,167,59,0.55)",
              }}
              whileHover={{ y: -3, boxShadow: "0 16px 40px -8px rgba(242,167,59,0.7)" }}
              whileTap={{ scale: 0.97 }}
            >
              <ScanLine size={20} />
              Start Screening Now
